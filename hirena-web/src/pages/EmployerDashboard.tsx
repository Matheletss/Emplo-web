...
interface Job {
  ...
  location: string;
  description: string;
  applicants?: number; // optional if not present in backend
}
...
const EmployerDashboard = () => {
  ...
  const handleViewApplicants = (jobId: string) => {
    navigate(`/EmployerDashboard/applicants/${jobId}`);
  };
    ...
    <Layout>
      <div className="min-h-screen bg-[#f9f5ef] text-[#4b3d30] p-8 font-sans">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-white border border-[#e6ddd3] rounded-xl p-6 shadow-sm text-center">
            <p className="text-xl font-semibold text-[#4b3d30]">
      ...
      {/* For nested routes like /EmployerDashboard/applicants/:id */}
      <div className="p-8 bg-white border-t border-gray-300">
        <Outlet />
      </div>
    </Layout>
